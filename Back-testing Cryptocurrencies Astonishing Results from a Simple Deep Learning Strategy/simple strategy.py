...
# Valores de normalización (ajusta estos valores a los que usaste para normalizar)
min_close = data['close'].min()
max_close = data['close'].max()

# Normalizar los datos de cierre
...
while current_date < end_date:
    ...
    # Extraer la ventana de datos normalizados
...
plt.fill_between(comparison_df['date'], comparison_df['prediction'] - mae, comparison_df['prediction'] + mae, color='gray', alpha=0.2, label='Error Band (MAE)')
plt.xlabel('Date')
plt.ylabel('Price')
